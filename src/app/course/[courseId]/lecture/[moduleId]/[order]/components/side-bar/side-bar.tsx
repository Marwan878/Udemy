...
export default function SideBar() {
  ...
  const handleCheckboxChange = async (
    ...
    const moduleToBeUpdatedIndex = modules.indexOf(
  ...
  return (
    <div className="sticky top-0 h-[calc(100vh-48.8px)] md:basis-[30rem] xl:basis-[40rem]">
      {isCollapsed && (
        <Button
          height="md"
          variant="primary"
          className="absolute top-24 right-0 border border-[#9194ac] translate-x-[11.5rem] hover:translate-x-0 transition-transform duration-500"
